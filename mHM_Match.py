...
np.savetxt(mhm_path + '/mHM_locations_EFAS_grid_.txt', St_locs, fmt='%s', delimiter=',',)
...
# #St_locs = np.loadtxt(valid_path + 'out/Stations_locations_EFAS_grid_'+str(y)+'.txt', delimiter=',')
